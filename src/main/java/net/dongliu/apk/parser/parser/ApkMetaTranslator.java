        ...
        switch (xmlNodeStartTag.getName()) {
            ...
            case "meta-data":
                ...
                if (TextUtil.isNotEmpty(n)) {
                    if (n.equals("bluefinUpdateInfo")) {
                        apkMeta.setUpdateInfo(v);
                    } else if (n.equals("bluefinExtData")) {
                        apkMeta.setExtData(v);
                    } else if (n.equals("bluefinidentify")) {
                        apkMeta.setIdentify(v);
                    }
                }
                break;
        }
